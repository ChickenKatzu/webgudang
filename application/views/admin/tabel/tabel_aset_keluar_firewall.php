  ...
  <section class="content">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form method="get" action="<?php echo site_url('aset/keluar_firewall'); ?>" class="form-inline pull-right">
      ...
      <div class="row mt-3">
        <div class="col-md-12">
          <form method="get" action="<?php echo site_url('aset/keluar_firewall'); ?>" class="form-inline">
